...
{
$id=$_GET['del'];
$que = mysqli_query($con,"DELETE FROM tblfaculty WHERE Id='$id'");
if($que == TRUE){
...
?>	
										<tr>
                                            ...
                                            <td>
<a href="manage-faculty.php?del=<?php echo $row['Id'];?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
